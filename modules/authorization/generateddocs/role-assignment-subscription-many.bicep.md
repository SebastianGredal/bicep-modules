# Role Assignment to Subscriptions

Module used to assign a role to multiple Subscriptions
...
```json
{
    ...
    "metadata": {
        "template": "modules/authorization/role-assignment-subscription-many.json"
    },
    "parameters": {
        "parSubscriptionIds": {
            "value": []
